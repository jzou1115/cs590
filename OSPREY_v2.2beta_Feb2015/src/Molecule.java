	...
	public void changeTorsion(int a1num, int a2num, int a3num, int a4num, double deltaTorsion,
		...
		int at4x3 = a4num * 3;
                ...
                /*Atom pseudoAtom2 = new Atom("a2", actualCoordinates[at2x3] - actualCoordinates[at3x3],
                        actualCoordinates[at2x3+1] - actualCoordinates[at3x3+1],
                        actualCoordinates[at2x3+2] - actualCoordinates[at3x3+2]);*/
                //MH 06/14: Explicitly creating an Atom is time-consuming, so just make coords
                double pseudoAtom2[] = new double[] {
                    actualCoordinates[at2x3] - actualCoordinates[at3x3],
                    actualCoordinates[at2x3+1] - actualCoordinates[at3x3+1],
                    actualCoordinates[at2x3+2] - actualCoordinates[at3x3+2]
                };
		...
		double a2ZAngleSC[] = pseudoAtom2.angleAboutZAxisSC();*/
                double a2YAngleSC[] = Atom.angleAboutAxisSC(pseudoAtom2[2],pseudoAtom2[0]);
		theRotation.yAxisRotate( -a2YAngleSC[0], a2YAngleSC[1], pseudoAtom2, 1);
		double a2ZAngleSC[] = Atom.angleAboutAxisSC(pseudoAtom2[1],-pseudoAtom2[0]);
	...
	private void connect(int atom1, int atom2){
		if (debug) {
			if (connected[atom1][0] >= 6){
				...
				System.out.println("molecAtNum: " +atom[atom1].moleculeAtomNumber 
                                        + " resAtNum: " + atom[atom1].residueAtomNumber
                                        + " resFullName: " + residue[atom[atom1].moleculeResidueNumber].fullName
                                        + " atomName: " + atom[atom1].name);
			}
		}

...
class PDBChemModel {
  ...
  // Reads a pdb file and creates a molecule object
	...
	private String getEleType(String str){
        ...
        //convenience method for loading molecule from specified PDB file
        static Molecule loadMolecule(String PDBName){
            Molecule m = new Molecule();
            try{
                    FileInputStream is = new FileInputStream(PDBName);

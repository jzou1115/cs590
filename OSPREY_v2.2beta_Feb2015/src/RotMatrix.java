...
public class RotMatrix implements Serializable
{
	...
	public void getRotMatrix(double fx, double fy, double fz, double angle,
        ...
        double[] rotateAboutPt(double x[], double rm[][], double pt[]){
            //rotate x about pt using rotation matrix rm
            double xRel[] = subtract(x,pt);
            double rotxRel[] = applyRotMatrix(rm,xRel);
            return add(rotxRel,pt);
        }
        ...
        double getLongitude(double pt[], double northPole[], double london[]){
            ...
            double ans = getAngle(ptComp,londonComp);

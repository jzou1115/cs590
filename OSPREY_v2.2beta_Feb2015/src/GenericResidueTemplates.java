...
public class GenericResidueTemplates implements Serializable{
	...
	String grFilename = "all_nuc94_and_gr.in";
        String grFilenameCHARMM = "all_nuc_and_gr_charmm.in";
	...
	GenericResidueTemplates() throws Exception {
                ...
                String curGRFilename = grFilename;
                if(EnvironmentVars.forcefld != EnvironmentVars.FORCEFIELD.AMBER)//CHARMM
                    curGRFilename = grFilenameCHARMM;
            
                    
		FileInputStream is = new FileInputStream( EnvironmentVars.getDataDir().concat(curGRFilename) );

...
public class EPICSettings implements Serializable {
    ...
    //compute ellipses to enclose non-clashing regions of conf space
    boolean calcNCEllipses;
    ...
    public EPICSettings(ParamSet params){
        ...
        calcNCEllipses = (new Boolean((String)params.getValue("CALCNCELLIPSES","false"))).booleanValue();

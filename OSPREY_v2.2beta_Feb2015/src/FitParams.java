...
public class FitParams implements Serializable {
    ...
    boolean increaseOrder(boolean useSVE){
    ...
    int compareTo(FitParams fp){
        ...
        if(order>fp.order)
            ...
            return Double.valueOf(explicitVDWCutoff).compareTo(Double.valueOf(fp.explicitVDWCutoff));
        }
    }

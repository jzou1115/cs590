...
\begin{document}
	...
	compare our graph-based algorithm). For FSV1, positions 10 and 27 were allowed to mutated.  For 1CC8, positions 38-44 were allowed to mutate, and for DHFR only position 5 was allowed to mutate.  By selecting a range of maximum mutations, we were able to assess the scalability of the algorithm.
...
\end{table}
	...
	labels applied to the wrong residue (Tables \ref{1fsv}, \ref{1cc8}). For 1FSV, allowing mutations at residue
